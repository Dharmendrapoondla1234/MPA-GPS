                ...
                <div className="dp-route-card">
                  <div className="dp-route-from">
                    ...
                    <div>
                      ...
                      <div className="dp-route-val">{lastPortDeparted || "—"}</div>
                      {lastArrivedTime  && <div className="dp-route-time">Arr: {formatTimestamp(lastArrivedTime)}</div>}
                      {lastDepartedTime && <div className="dp-route-time">Dep: {formatTimestamp(lastDepartedTime)}</div>}
                    </div>
                  </div>
                  <div className="dp-route-line">
                    <div className="dp-route-arrow">→</div>
                    {stats && <div className="dp-route-dist">{stats.dist} NM</div>}
                  </div>
                  <div className="dp-route-to">
                    <div className="dp-route-icon">🏁</div>
                    <div>
                      <div className="dp-route-label">DESTINATION</div>
                      <div className="dp-route-val">{nextPortDest || "Current Position"}</div>
                      {declaredArrivalTime && <div className="dp-route-time">ETA: {formatTimestamp(declaredArrivalTime)}</div>}
                    </div>
                  </div>
                </div>
              </>
