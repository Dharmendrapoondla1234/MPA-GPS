...
function normalizeVessel(v) {
  return {
    ...
    effective_timestamp:  bqStr(v.effective_timestamp) || bqStr(v.last_position_at),
    minutes_since_last_ping: bqNum(v.minutes_since_last_ping),
    is_stale:       bqBool(v.is_stale),
    ...
    last_arrived_time:     bqStr(v.last_arrived_time),
    last_departed_time:    bqStr(v.last_departed_time),
    // declaration
    ...
    // quality flags
    has_arrival_data:    bqBool(v.has_arrival_data),
    has_departure_data:  bqBool(v.has_departure_data),
    has_declaration_data:bqBool(v.has_declaration_data),
