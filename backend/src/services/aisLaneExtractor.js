...
// Uses f_vessel_positions_latest (MPA) — columns: latitude, longitude (radians), speed_kn, heading_deg
...
router.get("/trajectory/:imo", async (req, res, next) => {
  try {
    ...
    // f_vessel_positions_latest uses last_position_at and latitude/longitude (radians)
